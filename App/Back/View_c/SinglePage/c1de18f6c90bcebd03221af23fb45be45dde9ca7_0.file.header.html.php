<?php
/* Smarty version 3.1.29, created on 2018-03-01 04:30:46
  from "D:\phpStudy\WWW\blog\App\Back\View\Public\header.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a9781f6b401c2_78193796',
  'file_dependency' => 
  array (
    'c1de18f6c90bcebd03221af23fb45be45dde9ca7' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\blog\\App\\Back\\View\\Public\\header.html',
      1 => 1519873427,
      2 => 'file',
    ),
  ),
...
function content_5a9781f6b401c2_78193796 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                <li class="active"><a href="index.php?p=Back&c=Manage&a=index" class="icon-home"> 开始</a>
                    <ul><li><a href="index.php?p=Back&c=Category&a=index">分类管理</a></li>
                    <li><a href="index.php?p=Back&c=Article&a=index">文章管理</a></li>
                    <li><a href="index.php?p=Back&c=Message&a=index">评论管理</a></li>
                    <li><a href="index.php?p=Back&c=SinglePage&a=index">单页管理</a></li>
                    <li><a href="index.php?p=Back&c=Master&a=index">站长管理</a></li>
                    <!-- <li><a href="#">友情链接</a></li> --></ul>
                </li>
                <li><a href="index.php?p=Back&c=Category&a=index" class="icon-cog"> 分类</a>
                    <ul><li><a href="#">全局设置</a></li><li class="active"><a href="#">系统设置</a></li><li><a href="#">会员设置</a></li><li><a href="#">积分设置</a></li></ul>
                </li>
                <li><a href="index.php?p=Back&c=Article&a=index" class="icon-file-text">文章管理</a>
